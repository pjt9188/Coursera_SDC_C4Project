...
class PathOptimizer:
    ...
    def thetaf(self, a, b, c, d, s):
        # TODO: INSERT YOUR CODE BETWEEN THE DASHED LINES
        # ------------------------------------------------------------------
        # # Remember that a, b, c, d are constant and s is list
        # ...
    ...
    def sample_spiral(self, p):
        ...
        s_points = np.linspace(0.0, p[4])       # divide equally spaced intervals with 50 points
    ...
    def objective(self, p):
        ...
        fbe : f_bending energy
        fxf : f_x_f - final x position constraint
        fyf : f_y_f 
        """
